...
namespace Mortens_Komeback_3.Puzzles
{
    class OrderPuzzle : Puzzle
    {
        ...
        public OrderPuzzle(PuzzleType type, Vector2 spawnPos, Door puzzleDoor, Vector2 plaque1Pos, Vector2 plaque2Pos, Vector2 plaque3Pos) : base(type, spawnPos, puzzleDoor)
        {
